...
var shaderCode = `
    ...
    void main() {
        ...
        gl_FragColor.r = sin(u_time* 0.3 * gl_FragCoord.x * gl_FragCoord.y) * gl_FragColor.r;
        gl_FragColor.g = sin(u_time* 0.4 * gl_FragCoord.x * gl_FragCoord.y) * gl_FragColor.g;
        gl_FragColor.b = -sin(u_time* 0.2 * gl_FragCoord.x * gl_FragCoord.y)* gl_FragColor.b;
    }
`;
